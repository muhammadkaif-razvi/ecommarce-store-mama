...
const UserDropLinks: React.FC<UserDropLinksProps> = ({ user }) => {
  ...
  return (
    <>
      ...
      <DropdownMenuGroup>
        <DropdownMenuItem
          className={`p-2 text-gray-800 dark:text-slate-200 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-md transition-colors ${pathname === "/account/settings" ? "bg-blue-100 dark:bg-blue-900/30" : ""
            }`}
          asChild
        >
        ...
        <DropdownMenuItem
          className={`p-2 text-gray-800 dark:text-slate-200 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-md transition-colors ${pathname === "/account/profile" ? "bg-blue-100 dark:bg-blue-900/30" : ""
            }`}
          asChild
        >
        ...
        </DropdownMenuItem>
        {
          user && (
            <DropdownMenuItem
              className={`p-2 text-gray-800 dark:text-slate-200 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-md transition-colors ${pathname === "/account/order" ? "bg-blue-100 dark:bg-blue-900/30" : ""
                }`}
              asChild
            >
