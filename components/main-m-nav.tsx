...
export function MobileNav() {
  ...
  const routes = [
    ...
    {
      href: `/${params.storeId}/features`,
      label: "Features",
      active: pathname === `/${params.storeId}/features`,
    },
    {
      href: `/${params.storeId}/mileages`,
      label: "Mileage",
      active: pathname === `/${params.storeId}/mileages`,
    },
    {
      href: `/${params.storeId}/seats`,
      label: "Seats",
      active: pathname === `/${params.storeId}/seats`,
    },
    {
      href: `/${params.storeId}/engines`,
      label: "Engine",
      active: pathname === `/${params.storeId}/engines`,
    },
    {
      href: `/${params.storeId}/airbags`,
      label: "Airbags",
      active: pathname === `/${params.storeId}/airbags`,
    },
    {
