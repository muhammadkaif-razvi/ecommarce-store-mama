...
const NewPasswordPage = () => {
  return (
    <div className="flex lg:min-h-[92vh] min-h-[100vh] md:min-h-[96vh] lg:mt-14 mt-11 flex-col items-center justify-center dark:bg-gray-900 bg-blue-50 p-6 md:p-10"   style={{
